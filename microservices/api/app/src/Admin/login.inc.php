...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>CAPS</b> - GCoE, Jalgaon</a>
            <small>Central Application Processing System (CAPS) By Rizwan Syed</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="includes/login_chk.php" name="login_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <input class="btn btn-block bg-pink waves-effect" type="button" name="user_login" value="Login" onclick="return formhash(this.form,this.form.log_password)">
                        </div>
                    </div>
