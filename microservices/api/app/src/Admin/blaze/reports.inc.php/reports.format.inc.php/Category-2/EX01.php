...
exportMysqlToCsv($table,$rpt." - Form Data - ".$session." - ".$cat." - ".$gender.".csv",$mysqli);
...
function exportMysqlToCsv($table,$filename,$mysqli)
{
	...
	FROM $table WHERE pgender='$gender' AND session='$session' AND form_cat='$cat'";
