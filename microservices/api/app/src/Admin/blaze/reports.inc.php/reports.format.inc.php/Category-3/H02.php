...
$query5=mysqli_query($mysqli,"SELECT * FROM form_data WHERE  accd<>1 AND pclass='$cls'  AND pgender='$gender' AND session='$session' AND form_cat='$cat_s' ORDER BY ABS(sgpa) ASC")or die(mysqli_error($mysqli));
