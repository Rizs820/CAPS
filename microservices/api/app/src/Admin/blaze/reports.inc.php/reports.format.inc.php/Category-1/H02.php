...
$query5=mysqli_query($mysqli,"SELECT * FROM form_data WHERE  accd<>1 AND pclass='$cls'  AND pgender='$gender' AND session='$session' ORDER BY $vss,sgpa DESC,$psem")or die(mysqli_error($mysqli));
