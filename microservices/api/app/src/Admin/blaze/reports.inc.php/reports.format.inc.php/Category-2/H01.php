		...
		while($row2=mysqli_fetch_array($query2))
		{
			...
			else
			{
				...
				$psem="s".($row2['lsem']-1)."_sgpa DESC";
					...
					$query5=mysqli_query($mysqli,"SELECT * FROM form_data WHERE ver=1 AND accd<>1 AND pclass='$cls'  AND pgender='$gender' AND session='$session' ORDER BY ABS(sgpa) ASC")or die(mysqli_error($mysqli));
