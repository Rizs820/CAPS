...
if($myRequestArray[0]=="Edit_Form_C2")
{
...
?>
    ...
    <div class="container-fluid">
            <div class="block-header">
                <h2>FROM MANAGER (FM) / <?php echo $m_mode;?> / FY STUDENTS (FY) / <?php echo $session_year;?></h2>
            </div>    
            <!-- Vertical Layout -->
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        $query=mysqli_query($mysqli,"select * from department where hasres=1")or die(mysqli_error());
                                            ...
                                            {
                                                $d=$row['name'];
                                                $query1=mysqli_query($mysqli,"select * from cls WHERE stud_cat='Category-2'")or die(mysqli_error());
...
if(isset($_POST['update_form_c2']))
{
    ...
    **/
    ...
    if($stmt->execute())
    {
        alert_sweet_success_wr("Form Details Updated Successfully!!!","./?act=form/modify/category-2");
