...
?>
    <div class="container-fluid">
            <div class="block-header">
                <h2>FROM MANAGER (FM) /  CANCEL/REJECT (CR) / SY-LY STUDENTS (STL) / <?php echo $session_year;?></h2>
            </div>    
            <!-- Exportable Table -->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    <?php 
                                        $query = "SELECT prn,pname,pclass,sgpa,sysid,pc_no,canc,ver FROM form_data WHERE form_cat='Category-1' AND session='$session_year' ORDER BY sysid";
