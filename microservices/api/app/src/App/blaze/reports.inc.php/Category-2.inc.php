...
$pdf->SetFont('');
$pdf->Cell(30,7,"Application ID :",0,0,'L');
$pdf->SetFont('','B');
$pdf->Cell(35,7,$m_prn,'B',1,'C');
$pdf->SetFont('');
...
$pdf->SetFont('');
$pdf->Cell(40,7,"MH Merit No. : ",0,0,'L');
$pdf->SetFont('','B');
$pdf->Cell(25,7,$m_pclgname,'B',0,'C');
$pdf->SetFont('');
$pdf->Cell(5,7,"",0,0,'C');
$pdf->Cell(40,7,"AI Merit No. : ",0,0,'L');
$pdf->SetFont('','B');
$pdf->Cell(25,7,$m_ai_mn,'B',0,'C');
$pdf->Ln();
...
//foreach($header as $col)
	...
	$pdf->Cell(30,7,"Percentage",1,0,'C');
...
while($i<3)
{
	...
	{*/
		...
		if($i==1)
			$pdf->Cell(50,7,"10th Class",1,0,'C');
		else
			$pdf->Cell(50,7,"12th Class",1,0,'C');
		$pdf->Cell(30,7,${"sgpa".$i},1,0,'C');
		$pdf->Ln();
	//}
	$i=$i+1;
}
